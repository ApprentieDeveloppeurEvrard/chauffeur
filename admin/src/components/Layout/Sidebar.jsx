...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { path: '/drivers', icon: Users, label: 'Chauffeurs', color: 'text-green-500' },
    { path: '/offers', icon: Briefcase, label: 'Offres', color: 'text-purple-500' },
    { path: '/vehicles', icon: Car, label: 'Véhicules', color: 'text-blue-600' },
    { path: '/missions', icon: BarChart3, label: 'Missions', color: 'text-indigo-500' },
    { path: '/transactions', icon: DollarSign, label: 'Finances', color: 'text-yellow-500' },
    { path: '/support', icon: HeadphonesIcon, label: 'Support', color: 'text-orange-500' },
    { path: '/notifications', icon: Bell, label: 'Notifications', color: 'text-red-500' },
    { path: '/platform-config', icon: Cog, label: 'Configuration', color: 'text-gray-600' },
