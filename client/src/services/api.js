...
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://server-chauffeur.onrender.com/api'
const API_URL = import.meta.env.VITE_API_URL || 'https://server-chauffeur.onrender.com'
