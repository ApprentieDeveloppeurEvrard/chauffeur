...
export default function SignUpDriver() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log('Driver sign up data:', formData);
        // Add driver sign up logic here
    };
    ...
    return (
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl pb-6 overflow-hidden border border-white/20 hover:bg-white/15 transition-all max-w-[450px] w-full mx-auto">
            <div className="p-6">
                <h2 className="text-2xl font-bold mb-6 text-center text-white">Inscription Chauffeur</h2>
