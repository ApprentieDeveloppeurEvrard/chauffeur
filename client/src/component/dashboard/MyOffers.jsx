      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="divide-y divide-gray-200">
          {myOffers && myOffers.length > 0 ? myOffers.map(offer => (
            <div key={offer._id || offer.id} className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  ...
                  <button 
                    ...
                    disabled={loading}
                    className="group flex items-center justify-center gap-2 px-3 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 hover:text-indigo-800 rounded-lg border border-indigo-200 hover:border-indigo-300 transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md w-full sm:w-24 min-w-0 disabled:opacity-50"
                  ...
                  <button 
                    ...
                    disabled={loading}
                    className={`group flex items-center justify-center gap-2 px-3 py-2 rounded-lg border transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md w-full sm:w-24 min-w-0 disabled:opacity-50 ${
                      offer.status === 'active' 
                  ...
                  <button 
                    ...
                    disabled={loading}
                    className="group flex items-center justify-center gap-2 px-3 py-2 bg-red-50 hover:bg-red-100 text-red-700 hover:text-red-800 rounded-lg border border-red-200 hover:border-red-300 transition-all duration-200 text-sm font-medium shadow-sm hover:shadow-md w-full sm:w-24 min-w-0 disabled:opacity-50"
