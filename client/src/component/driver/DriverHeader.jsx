...
export default function DriverHeader({ searchQuery, setSearchQuery, notifications }) {
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-sm bg-green-100 text-green-800 px-2 py-1 rounded-full font-medium">Chauffeur</span>
        </Link>
