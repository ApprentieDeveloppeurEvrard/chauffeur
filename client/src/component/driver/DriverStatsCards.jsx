export default function DriverStatsCards({ availableOffers, myApplications, activeMissions, totalEarnings, stats, loading }) {
  const statsCards = [
    {
    ...
    },
    {
      ...
      value: loading ? '...' : `${stats?.profile?.totalEarnings || totalEarnings || 0}€`,
      icon: (
