export default function DriverPayments({ payments, totalEarnings }) {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Paiements & Revenus</h1>
        <p className="text-gray-600">Historique de vos revenus et paiements reçus</p>
      </div>
        ...
        <div className="p-6">
          <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500">Graphique des revenus des 6 derniers mois</p>
            </div>
          </div>
        </div>
      </div>
              ...
              {payments?.map(payment => (
                <tr key={payment.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      <div className="text-sm font-medium text-gray-900">{payment.missionTitle}</div>
                      <div className="text-sm text-gray-500">{payment.missionType}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{payment.employer}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                      ...
                      {payment.status === 'paid' ? 'Payé' : payment.status === 'pending' ? 'En attente' : 'En cours'}
                    </span>
                  </td>
                ...
                <tr>
                  <td colSpan="6" className="px-6 py-12 text-center">
                    <div className="text-gray-500">
                      ...
                      <p className="text-sm">Vos paiements apparaîtront ici une fois vos missions terminées.</p>
                    </div>
                  </td>
                </tr>
              )}
